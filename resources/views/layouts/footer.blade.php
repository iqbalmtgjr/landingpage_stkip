        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex pt-2">
                    <a class="btn btn-square btn-outline-light me-1" href="https://twitter.com/stkip_persada"><i
                            class="fab fa-twitter"></i></a>
                    <a class="btn btn-square btn-outline-light me-1"
                        href="https://www.facebook.com/stkippersadakhatulistiwa.sintang"><i
                            class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-square btn-outline-light me-1"
                        href="https://www.youtube.com/channel/UCLIubTmxtnIqVlI_KJlR36Q"><i
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                &copy; <a href="#">STKIP Persada Khatulistiwa 2022</a>, All Right Reserved.
            </div>
