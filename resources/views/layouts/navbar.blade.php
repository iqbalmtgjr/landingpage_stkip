        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                ...
                <div class="h-100 d-inline-flex align-items-center">
                    ...
                    <small>Senin - Jum'at : 07.40 AM - 04.40 PM, Sabtu : 07:00 - 12:00</small>
                </div>
            </div>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a class="dropdown-item" href="#">Pendidikan Pancasila dan Kewarganegaraan</a>
                        <a class="dropdown-item" href="#">Pendidikan Guru Sekolah Dasar</a>
                        <a class="dropdown-item" href="#">Pendidikan Ekonomi</a>
                        <a class="dropdown-item" href="#">Pendidikan Anak Usia Dini</a>
                        <a class="dropdown-item" href="#">Pendidikan Matematika</a>
                        <a class="dropdown-item" href="#">Pendidikan Komputer</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Lembaga</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="feature.html" class="dropdown-item">UPT. LAB. DAN MICROTEACHING</a>
                        <a href="appointment.html" class="dropdown-item">UPT. PERPUSTAKAAN</a>
                        <a href="team.html" class="dropdown-item">LEMBAGA BUDAYA DAN BAHASA KALIMANTAN</a>
                        <a href="testimonial.html" class="dropdown-item">KEWIRAUSAHAAN</a>
                        <a href="404.html" class="dropdown-item">KEMAHASISWAAN DAN ALUMNI</a>
                        <a href="404.html" class="dropdown-item">Lembaga Penelitian dan Pengabdian Masyrakat</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">PMB</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Informasi</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="feature.html" class="dropdown-item">Donwload Fomat Surat</a>
                        <a href="appointment.html" class="dropdown-item">Berita</a>
                        <a href="team.html" class="dropdown-item">Informasi Beasiswa</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">E-Learn</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="feature.html" class="dropdown-item">E-Learning</a>
                        <a href="appointment.html" class="dropdown-item">E-Library</a>
                        <a href="team.html" class="dropdown-item">Kalender Akademik</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">SISTER</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
